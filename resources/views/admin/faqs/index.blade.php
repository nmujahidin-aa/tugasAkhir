                    ...
                    <table class="table table-hover my-0" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->answer}}</td>
                                <td>
                                    <a href="{{route('dashboard.faqs.show',$row->id)}}" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                    <a href="{{route('dashboard.faqs.edit',$row->id)}}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
