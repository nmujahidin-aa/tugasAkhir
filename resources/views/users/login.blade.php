				...
				<div class="card">
					<div class="card-body shadow-lg bg-body rounded">
						<form method="POST" action="/login">
			                ...
			                <hr>
								<p class="text-center h4   mx-1 mx-md-4 mt-4">Masuk</p>
                  				<p class="text-center "style="font-weight: 350; font-size:15px;"> belum punya akun? 
                  					<a href="register" style="font-weight: 350; font-size:15px; text-decoration:none">Daftar</a>
                  				</p>
